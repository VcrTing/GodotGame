...
public partial class BulletXigua : Node2D, IBulletBase, IObj, IAttack, IWorking
{
    
    [Export]
    public bool IsManyDamage = true; // 是否多段伤害
    ...
    private int DamageExtra = BulletConstants.DamageBasic;
